...
class Session {
  ...
  rowsToFighters(rows) {
    return (rows || []).map(r => ({
      ...
      hb: r[14] ? { dx: r[14][0], dy: r[14][1], hw: r[14][2], hh: r[14][3], active: !!r[14][4], round: r[11] === 'nspin', blade: r[11] === 'slash', spear: r[11] === 'thrust', hammerThrust: r[11] === 'hthrust', chg: r[14][5] || 0, hammerAir: !!r[14][6] } : null,
  ...
  interpolate(renderTime) {
    ...
    const projectiles = (b.s.p || []).map(p => ({ eid: p[0], kind: p[1], x: p[2], y: p[3], r: p[5] || 0, arm: p[6] || 0, section: p[7] ?? -1, bombR: p[8] || 0, glow: !!p[9], aimX: p[10] || 0, aimY: p[11] || 0 }));
